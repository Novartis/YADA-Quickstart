...
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA insert default param','insert into YADA_PARAM (target, name, value, rule) values (?v,?v,?v,?i)','YADABOT','YADA');
